...
`
	...
	// t.TempDir spelling (/var/folders/...) resolves to /private/var/... The
	// display strings are sanitized-output concatenations, so resolve the
	// parent (which exists) and rebuild them from it.
